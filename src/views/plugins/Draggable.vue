<template>
  <div>
    ...
    >
      ...
      >
        <resize-observer @notify="handleResize(item)"/>
        <CCard 
...
const localStorageKey = 'CoreUI-Vue-Draggable-Layouts'
